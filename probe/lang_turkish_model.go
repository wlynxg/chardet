...
func NewIso88599TurkishModel() SingleByteCharSetModel {
	// 3: Positive
	// 2: Likely
	// 1: Unlikely
	// 0: Negative

	TurkishLangModel := map[int]map[int]int{
		23: { // 'A'
			23: 0, // 'A'
			37: 0, // 'B'
			47: 0, // 'C'
	...
	Iso88599TurkishCharToOrder := map[int]int{
		0:   255, // '\x00'
		1:   255, // '\x01'
		2:   255, // '\x02'
		3:   255, // '\x03'
