...
func greekLangModel() map[int]map[int]int {
...
func NewISO88597GreekModel() SingleByteCharSetModel {
	Iso88597GreekCharToOrder := map[int]int{
		0:   255, // '\x00'
		1:   255, // '\x01'
		2:   255, // '\x02'
		3:   255, // '\x03'
...
func NewWindows1253GreekModel() SingleByteCharSetModel {
	Windows1253GreekCharToOrder := map[int]int{
		0:   255, // '\x00'
		1:   255, // '\x01'
		2:   255, // '\x02'
		3:   255, // '\x03'
